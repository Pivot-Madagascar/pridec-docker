...
execute-dir: project
params:
  config_json: "output/config.json"
---

```{r}
#| eval: false
#for testing
params <- list("config_json" = "output/config.json")
...
input_set <- readRDS(here("output/input_data.RData"))
...
## Add table of forecasts or some other sanity check. distribution?
